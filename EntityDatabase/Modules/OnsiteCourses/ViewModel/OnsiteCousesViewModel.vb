...
Namespace Modules.OnsiteCourses.ViewModels
    Public Class OnsiteCousesViewModel
        ...
        Public Property OnsiteCourse As ObservableCollection(Of OnsiteCourse)
            Get
        ...
        Private Function GetAllOnlineCourse() As IQueryable(Of OnsiteCourse)
        ...
        Sub New()
            ...
            For Each element In Me.GetAllOnlineCourse
